  ...
  const highlights = [
    {
      ...
      description: 'Applying rigorous scientific methodology to solve complex biological and healthcare challenges.'
    },
    {
      icon: Lightbulb,
      title: 'Innovation Focused',
      description: 'Developing AI-driven solutions that bridge the gap between academic research and real-world applications.'
    },
    {
      icon: TrendingUp,
      title: 'Impact Oriented',
      description: 'Committed to translating discoveries into scalable, practical tools that advance healthcare outcomes.'
    }
  ];

  return (
    <section id="about" ref={sectionRef} className="py-20 md:py-32 bg-white dark:bg-slate-800">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
              I am a computational biologist and data scientist driven by a passion for research and scientific precision. My work focuses on transforming complex biological data into actionable insights that advance healthcare outcomes.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-700 rounded-lg">
                <div className="text-3xl font-bold text-emerald-600 mb-1">$12K+</div>
          ...
          <div className={`space-y-6 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            {highlights.map((item, index) => (
              <div
                key={index}
                className="flex gap-4 p-6 bg-slate-50 dark:bg-slate-700 rounded-xl hover:shadow-lg transition-all duration-300"
