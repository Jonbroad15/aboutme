        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              ...
              {/* Center Content */}
              <div className="absolute inset-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center shadow-2xl">
                <div className="text-white text-center">
                  <div className="text-5xl font-bold mb-2">JB</div>
                  <div className="text-sm opacity-80">Computational Biologist</div>
                </div>
              </div>
